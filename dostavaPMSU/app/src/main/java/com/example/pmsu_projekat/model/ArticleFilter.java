...
public class ArticleFilter implements Serializable {
    ...
    public ArticleFilter(String naziv, String opis, Integer cenaOd, Integer cenaDo, Integer ocenaOd, Integer ocenaDo, Integer brojOcenaOd, Integer brojOcenaDo, long prodavacId) {
        this.naziv = naziv;
        this.opis = opis;
        this.cenaOd = cenaOd;
        this.cenaDo = cenaDo;
    ...
    public long getProdavacId() { return prodavacId; }

    public void setProdavacId(long prodavacId) { this.prodavacId = prodavacId; }
}
