...
public class CommentsActivity extends AppCompatActivity {
    ...
    private void getComments(){
        ...
        call.enqueue(new Callback<List<Order>>() {
            ...
            public void onResponse(Call<List<Order>> call, Response<List<Order>> response) {
                ...
                Log.d("DataCheck",new Gson().toJson(orders));
                mListView.setAdapter(new CommentListAdapter(getApplicationContext(), R.layout.layout_comment, orders));
            }
    ...
    private void toolbarAndDrawer(){
        ...
        NavigationView navigationView = (NavigationView) findViewById(R.id.navigation_view_comments);
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                if (menuItem.getTitle().equals("Kreiraj artikal")){
                    Intent intent = new Intent(CommentsActivity.this, CreateArticleActivity.class);
                    Bundle b = new Bundle();
                ...
                if (menuItem.getTitle().equals("Prodavnice")){
                    Intent intent = new Intent(CommentsActivity.this, RestaurantsActivity.class);
                    startActivity(intent);
                }
